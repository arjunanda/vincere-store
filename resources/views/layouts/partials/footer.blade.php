...
<div class="whatsapp-float flex" x-data="{ open: false }">
    ...
    <div class="flex flex-col gap-4 mb-2" 
        ...
        <!-- WhatsApp -->
        <a href="https://wa.me/{{ $waCS }}?text=Halo%20Admin%20{{ urlencode($webSettings['web_title'] ?? 'Vincere Store') }},%20saya%20ingin%20bertanya%20tentang..." target="_blank" class="cs-menu-item cs-wa group">
            <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
