<footer class="bg-black py-24 px-6 mt-40 border-t border-white/5">
    ...
    <div class="max-w-7xl mx-auto mt-24 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-12">
        ...
        <div class="flex items-center gap-12">
            <div class="flex gap-10 text-gray-600 text-xs font-bold uppercase tracking-widest">
            ...
            <div class="flex gap-6 items-center">
                ...
                @if($waCS)
                <a href="https://wa.me/{{ $waCS }}" target="_blank" class="text-gray-600 hover:text-brand-red transition-colors" title="WhatsApp">
                ...
                @if($igLink !== '#')
                <a href="{{ $igLink }}" target="_blank" class="text-gray-600 hover:text-brand-red transition-colors" title="Instagram">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
