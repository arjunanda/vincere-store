...
<body class="dashboard-layout" x-data="{ sidebarOpen: false }" @close-sidebar.window="sidebarOpen = false">
    ...
    <aside class="sidebar" :class="sidebarOpen ? 'open' : ''">
        ...
        <nav class="flex-1 py-8 overflow-y-auto custom-scrollbar">
            ...
            <a href="{{ route('dashboard.index') }}" class="sidebar-item {{ Route::is('dashboard.index') ? 'active' : '' }}">
            ...
            @if(auth()->user() && auth()->user()->role === 'admin')
                ...
                <a href="{{ route('dashboard.games') }}" class="sidebar-item {{ Route::is('dashboard.games*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    Kelola Game
                </a>
                <a href="{{ route('dashboard.categories.index') }}" class="sidebar-item {{ Route::is('dashboard.categories.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" /></svg>
                    Master Kategori
                </a>
                <a href="{{ route('dashboard.inputs') }}" class="sidebar-item {{ Route::is('dashboard.inputs') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13l-3 3m0 0l-3-3m3 3V8" /></svg>
                    Master Input
                </a>
                <a href="{{ route('dashboard.banners') }}" class="sidebar-item {{ Route::is('dashboard.banners') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                    Kelola Banner
                </a>
                <a href="{{ route('dashboard.articles') }}" class="sidebar-item {{ Route::is('dashboard.articles') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10l4 4v10a2 2 0 01-2 2z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 2v4a2 2 0 002 2h4" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h3" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12h8" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16h8" /></svg>
                    Kelola Artikel
                </a>
                ...
                <a href="{{ route('dashboard.orders') }}" class="sidebar-item {{ Route::is('dashboard.orders') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
                    Semua Pesanan
                </a>
                <a href="{{ route('dashboard.payments') }}" class="sidebar-item {{ Route::is('dashboard.payments') ? 'active' : '' }}">
                ...
                <a href="{{ route('dashboard.users') }}" class="sidebar-item {{ Route::is('dashboard.users') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                    Kelola User
                </a>
                <a href="{{ route('dashboard.logs') }}" class="sidebar-item {{ Route::is('dashboard.logs') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    Riwayat Aktivitas
                </a>
@else
                <!-- User Specific Menus -->
                <a href="{{ route('dashboard.my-orders') }}" class="sidebar-item {{ Route::is('dashboard.my-orders') ? 'active' : '' }}">
...
@endif
            ...
            <a href="{{ route('dashboard.profile') }}" class="sidebar-item {{ Route::is('dashboard.profile') ? 'active' : '' }}">
            ...
            <a href="{{ route('dashboard.security') }}" class="sidebar-item {{ Route::is('dashboard.security') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                Keamanan
            </a>

            @if(auth()->user()->role === 'admin')
            <a href="{{ route('dashboard.settings') }}" class="sidebar-item {{ Route::is('dashboard.settings') ? 'active' : '' }}">
        ...
        <div class="p-8 border-t border-white/5">
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="sidebar-item text-gray-500 w-full text-left">
    ...
    <main class="main-content">
        ...
        <!-- Top Bar Mobile -->
        <header class="flex items-center justify-between mb-8 lg:hidden bg-brand-dark/50 backdrop-blur-md p-4 -mx-4 border-b border-white/5 sticky top-0 z-40">
            <x-logo size="xs" />
            <button @click="sidebarOpen = true" class="p-2 bg-brand-red rounded-lg text-white shadow-lg shadow-brand-red/20">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
