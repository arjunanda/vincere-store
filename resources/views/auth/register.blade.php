...
<div class="w-full max-w-2xl" x-data="{ loading: false }">
    ...
    <div class="metal-card p-6 md:p-14 rounded-2xl relative overflow-hidden shadow-2xl">
        ...
        <div class="relative z-10">
            <h1 class="text-3xl md:text-4xl font-black tracking-tighter metallic-text uppercase  mb-2 text-center">Buat Akun</h1>
            ...
            <div class="mt-12 pt-8 border-t border-white/5 text-center">
                <p class="text-gray-500 text-xs font-medium">Sudah menjadi member? 
                    <a href="{{ route('login') }}" class="text-white font-bold hover:text-brand-neon transition-colors">Masuk Sekarang</a>
                </p>
            </div>
        </div>
    </div>
