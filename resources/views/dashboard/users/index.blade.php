...
<div class="space-y-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h1 class="text-3xl font-black  uppercase tracking-tight text-white">Kelola <span class="text-brand-neon">User</span></h1>
        ...
        <div class="w-full overflow-x-auto scrollbar-hide">
            <table class="w-full text-left border-collapse min-w-[600px] md:min-w-full table-auto">
                ...
                <tbody class="divide-y divide-white/5">
                    ...
                    <tr class="hover:bg-white/[0.01] transition-colors group">
                        <td class="p-6">
                            <div class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-full bg-brand-neon/10 flex items-center justify-center text-brand-neon font-black">
                        ...
                        <td class="p-6">
                            @if($user->role === 'admin')
                                <span class="px-3 py-1 bg-brand-neon/10 text-brand-neon text-[9px] font-black uppercase tracking-widest rounded-full border border-brand-neon/20">Admin</span>
                            @else
                        ...
                        <td class="p-6 text-right">
                            <div class="flex items-center justify-end gap-3">
                                <a href="{{ route('dashboard.users.edit', $user) }}" class="p-1.5 hover:text-brand-neon transition-colors text-gray-400">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="p-12 text-center text-gray-600 font-medium ">Belum ada user yang terdaftar.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
