...
<div class="max-w-3xl mx-auto">
    <div class="mb-8">
        <a href="{{ route('dashboard.users') }}" class="text-[10px] font-black uppercase tracking-widest text-gray-500 hover:text-brand-red flex items-center gap-2 mb-2 transition-colors">
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" /></svg>
            Kembali
        </a>
        <h1 class="text-2xl font-black italic uppercase tracking-tight text-white">Edit <span class="text-brand-red">User</span></h1>
        ...
        <div class="stat-card">
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-[10px] font-black uppercase tracking-widest text-gray-500">Nama Lengkap <span class="text-brand-red">*</span></label>
                    ...
                    <div class="space-y-2">
                        <label class="text-[10px] font-black uppercase tracking-widest text-gray-500">Email Address <span class="text-brand-red">*</span></label>
                        <input type="email" name="email" value="{{ $user->email }}" class="w-full input-metal py-3 px-4 rounded-xl text-xs" required>
                        @error('email') <p class="text-brand-red text-[10px] italic mt-1">{{ $message }}</p> @enderror
                    </div>

                    <div class="space-y-2">
                        <label class="text-[10px] font-black uppercase tracking-widest text-gray-500">Role Akses <span class="text-brand-red">*</span></label>
                        ...
                        @error('role') <p class="text-brand-red text-[10px] italic mt-1">{{ $message }}</p> @enderror
                    </div>
                </div>

                <div class="p-4 bg-white/5 rounded-xl border border-white/5">
                    <h4 class="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 italic">Ganti Password (Opsional)</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            @error('password') <p class="text-brand-red text-[10px] italic mt-1">{{ $message }}</p> @enderror
                        </div>
