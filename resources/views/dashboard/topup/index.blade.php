...
<div class="space-y-8">
    <div>
        <h1 class="text-3xl font-black  uppercase tracking-tight metallic-text">Top-up <span class="text-brand-neon">Poin</span></h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="stat-card">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <button class="p-6 bg-white/[0.03] border border-white/5 rounded-2xl hover:border-brand-neon/50 transition-all text-left group">
                    <p class="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-1">Top-up</p>
                    <p class="font-black  text-lg group-hover:text-brand-neon">Rp {{ number_format($amount, 0, ',', '.') }}</p>
                </button>
                @endforeach
            </div>
        </div>

        <div class="stat-card bg-brand-neon/5 border-brand-neon/20 border">
            <div class="flex items-center gap-4 mb-6">
                <div class="p-3 bg-brand-neon rounded-xl text-white">
