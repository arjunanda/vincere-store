...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-black italic uppercase tracking-tight text-white">Tambah <span
                    class="text-brand-red">Game Baru</span></h1>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    <div class="stat-card space-y-4" x-data="{ 
                        ...
                        <label class="text-[10px] font-black uppercase tracking-widest text-gray-500 block">Gambar Game <span class="text-brand-red">*</span></label>
                        ...
                        <div class="p-4 bg-brand-red/5 rounded-xl border border-brand-red/10">
                            <h4 class="text-[10px] font-black uppercase tracking-widest text-brand-red mb-1 text-center">Rekomendasi</h4>
