    ...
    <div class="space-y-8 max-w-2xl mx-auto">
        <div>
            <a href="{{ route('dashboard.games.items', $variant->game_id) }}"
                class="text-xs font-black uppercase tracking-widest text-gray-500 hover:text-brand-red flex items-center gap-2 mb-4 transition-colors">
            ...
            <h1 class="text-3xl font-black italic uppercase tracking-tight text-white">Edit <span
                    class="text-brand-red">Item</span></h1>
