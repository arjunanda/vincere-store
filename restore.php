<?php
$changes = [
    ["file" => "resources/views/components/logo.blade.php", "search" => "<span class=\"{{ \$current['ventuz'] }} font-black italic tracking-tighter text-white uppercase pr-2\">Ventuz</span>", "replace" => "<span class=\"{{ \$current['ventuz'] }} font-black italic tracking-tighter metallic-text uppercase pr-2\">Ventuz</span>"],
